...
function multiplyArray(multArr) {
  //eslint-disable-line
  let product1st = multiply(multArr[0],multArr[1])[0];
  let Resproduct = [multiply(product1st,multArr[2])[0], `The numbers ${multArr} have a product of ${multiply(product1st,multArr[2])[0]}.`]
  return Resproduct;
}
